...
public enum RegionText {
	...
	REGION_SELLING_LOAD_EXCEPTION("Exception loading selling region. See log for details"),
	...
	REGION_DIMENSION_EXISTS("A Global Region for this Dimension already exists!"),
	DIMENSION_NOT_FOUND("Dimension not found"),
	REGION_COPIED("Region copied!"),
	REGION_BOUGHT("Someone bought your Region!"),
    ...
    PLAYER_MAX_REGIONS("You can't be in more Regions"),
    ...
    PURCHASABLE_REGIONS_DISABLED("Regions can't be selled! Enable this by setting the PURCHASABLE_REGIONS setting in the config file to true"),
    NO_REGIONS_SELLED("There are no Regions to buy!"),
    REGION_SELLED("Region selled!"),
    REGION_SELLED_REMOVE("Region removed from selling!"),
    REGION_BUYED("Region buyed!"),
    ...
    TEXT_EFFECT_ADDED("Effect added to this Region!"),
    TEXT_EFFECT_REMOVED("Effect removed from this Region!"),
    TEXT_WRONG_EFFECT_LEVEL("Incorrect value set for effect level. Must be greater or equal than 0!"),
    TEXT_WRONG_PURCHASE_COST("Incorrect value set for purchase cost. Must be greater than 0!"),
